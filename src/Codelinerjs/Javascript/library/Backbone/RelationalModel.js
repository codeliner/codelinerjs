...
ClBackbone.RelationalModel = function() {};

ClBackbone.RelationalModel = $CL.extendClass(ClBackbone.RelationalModel, Backbone.RelationalModel, {
    extend : function (protoProps, classProps) {
        var child = Backbone.Model.extend.apply( this, arguments );

		child.setup( this );
        child.on("all", $CL.bind(this.triggerClEvent, this));
...
_.extend(ClBackbone.RelationalModel.prototype, Cl.Event.EventManagerProvider);
